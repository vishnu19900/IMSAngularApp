...
export class UpdatePurchasesComponent {
  ...
  constructor(private _http: HttpClient, private _route: Router, private _activate: ActivatedRoute, private _spinner: NgxSpinnerService ) {
  ...
  updatepurchases() {
    ...
    this._http.put('https://localhost:7031/api/Purchases/Updatedata', this.purchasesForm.value)
      .subscribe((res: any) => {
       // this._spinner.hide();
        this._route.navigate(['/purchasess']);        
      });
